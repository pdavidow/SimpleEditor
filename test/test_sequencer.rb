...
class Test_Sequencer < Test::Unit::TestCase
  ...
  def test_sequence_1
    sequencer = Sequencer.new(input_filename: TEST_INPUT_GOOD_FILE_NAME_1)
  ...
  def test_sequence_2
    sequencer = Sequencer.new(input_filename: TEST_INPUT_GOOD_FILE_NAME_2)
  ...
  def test_sequence_3
    sequencer = Sequencer.new(input_filename: TEST_INPUT_BAD_FILE_NAME_12)
  ...
  def test_sequence_4
    sequencer = Sequencer.new(input_filename: TEST_INPUT_BAD_FILE_NAME_13)
