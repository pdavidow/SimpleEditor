...
class Test_Editor < Test::Unit::TestCase
  ...
  def test_append_1
    ...
    self.assert_equal(1, m2.undos.length)
    self.assert_equal(TYPE_UNDO_APPEND, m2.undos[0].type_code)
    ...
    self.assert_equal(3, m2.appendage_length_sum)
    self.assert_equal(0, m2.char_delete_count_sum)
    self.assert_equal(2, m3.undos.length)
    self.assert_equal(TYPE_UNDO_APPEND, m3.undos[1].type_code)
  ...
  def test_delete_1
    ...
    self.assert_equal(0, m2.char_delete_count_sum)
    self.assert_equal(2, m3.undos.length)
    self.assert_equal(TYPE_UNDO_DELETE, m3.undos[1].type_code)
    self.assert_equal(6, m3.appendage_length_sum)
    ...
    self.assert_equal(6, m3.appendage_length_sum)
    self.assert_equal(1, m3.char_delete_count_sum)
    self.assert_equal(3, m4.undos.length)
    self.assert_equal(TYPE_UNDO_DELETE, m4.undos[2].type_code)
  ...
  def test_undo
    ...
    self.assert_equal('a', m2.string)
    self.assert_equal(2, m3.undos.length)
    self.assert_equal(TYPE_UNDO_APPEND, m3.undos[0].type_code)
    self.assert_equal(TYPE_UNDO_APPEND, m3.undos[1].type_code)
    ...
    self.assert_equal('ab', m3.string)
    self.assert_equal(3, m4.undos.length)
    self.assert_equal(TYPE_UNDO_APPEND, m4.undos[0].type_code)
    self.assert_equal(TYPE_UNDO_APPEND, m4.undos[1].type_code)
    self.assert_equal(TYPE_UNDO_APPEND, m4.undos[1].type_code)
    ...
    self.assert_equal(TYPE_UNDO_APPEND, m4.undos[1].type_code)
    self.assert_equal('abc', m4.string)
    self.assert_equal(2, m5.undos.length)
    self.assert_equal(TYPE_UNDO_APPEND, m5.undos[0].type_code)
    self.assert_equal(TYPE_UNDO_APPEND, m5.undos[1].type_code)
    ...
    self.assert_equal(TYPE_UNDO_APPEND, m5.undos[1].type_code)
    self.assert_equal('ab', m5.string)
    self.assert_equal(1, m6.undos.length)
    self.assert_equal(TYPE_UNDO_APPEND, m6.undos[0].type_code)
    ...
    self.assert_equal(TYPE_UNDO_APPEND, m6.undos[0].type_code)
    self.assert_equal('a', m6.string)
    self.assert_equal(0, m7.undos.length)
    ...
    self.assert_equal(0, m7.undos.length)
    self.assert_equal('', m7.string)
    self.assert_equal(0, m8.undos.length)
